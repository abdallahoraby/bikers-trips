...
// Endpoint to get all upcoming trips
...
add_action( 'rest_api_init', function (){
    ...
    register_rest_route( API_PATH, '/listUpcomingTrips' , array(
        'methods' => 'POST', // define the method GET or POST
        'callback' => 'listUpcomingTrips', // define the function that we call to get or post these data
    ) );
